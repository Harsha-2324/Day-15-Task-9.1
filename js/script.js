...
description.innerText =
  "Pagination is the process of dividing a large data set into multiple pages. It can also refer to the automated process of adding consecutive numbers to identify the sequential order of pages.";
